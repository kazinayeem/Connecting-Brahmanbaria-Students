  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-950 via-slate-900 to-brand-950 text-white pt-8 sm:pt-12 pb-14 sm:pb-20 lg:pt-20 lg:pb-28">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative rounded-3xl overflow-hidden border-2 border-emerald-500/30 shadow-2xl bg-slate-800/80 backdrop-blur-xl group">
                <img
                  ...
                  className="w-full h-72 xs:h-80 sm:h-96 object-cover object-center transform group-hover:scale-105 transition-transform duration-700 opacity-95"
                  loading="eager"
                  width="1200"
                  height="600"
                />
              ...
              <div className="absolute -top-4 sm:-top-6 -left-2 sm:-left-6 p-3 sm:p-4 rounded-2xl bg-slate-900/90 backdrop-blur-xl border border-emerald-500/40 shadow-xl hidden xs:flex items-center gap-2.5 sm:gap-3 animate-float">
              ...
              <div className="absolute -bottom-4 sm:-bottom-6 -right-2 sm:-right-6 p-3 sm:p-4 rounded-2xl bg-slate-900/90 backdrop-blur-xl border border-crimson-500/40 shadow-xl hidden xs:flex items-center gap-2.5 sm:gap-3">
        ...
        <div className="mt-10 sm:mt-16 pt-8 sm:pt-10 border-t border-emerald-900/60 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 text-center">
          <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900/40 border border-slate-800 hover:border-emerald-700/50 transition-colors">
            <span className="text-2xl sm:text-4xl font-black text-emerald-400 block tracking-tight">
              500+
            </span>
          ...
          <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900/40 border border-slate-800 hover:border-emerald-700/50 transition-colors">
            <span className="text-2xl sm:text-4xl font-black text-teal-300 block tracking-tight">
              15+
            </span>
            <span className="text-xs sm:text-sm text-slate-400 font-medium mt-1 block">
          ...
          <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900/40 border border-slate-800 hover:border-emerald-700/50 transition-colors">
            <span className="text-2xl sm:text-4xl font-black text-crimson-400 block tracking-tight">
              50+
            </span>
            <span className="text-xs sm:text-sm text-slate-400 font-medium mt-1 block">
              {t('hero.statEvents')}
