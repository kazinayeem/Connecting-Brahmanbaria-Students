...
import { 
  ...
  Activity, Bell, Image, MapPin, UserPlus, Mail, ChevronRight, Compass, Sparkles 
} from 'lucide-react';
...
export const Navbar = () => {
  ...
  return (
    <header className={`sticky top-0 z-50 transition-all duration-300 ${
      scrolled 
        ? 'bg-brand-950/95 backdrop-blur-md shadow-lg border-b border-brand-800/40 py-2.5' 
        : 'bg-gradient-to-r from-brand-950 via-brand-900 to-brand-950 text-white py-3.5 border-b border-brand-800/30'
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group focus:outline-none">
            <div className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-full overflow-hidden shadow-md ring-2 ring-emerald-400/40 group-hover:ring-emerald-300 transition-all transform group-hover:scale-105">
              <img src="/logo.svg" alt="BSA-DIU Logo" className="w-full h-full object-cover" />
            </div>
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                ...
                <span className="hidden xs:inline-block px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider bg-crimson-600/90 text-white rounded">
                  Community
                </span>
              </div>
              <span className="text-xs text-emerald-300/90 font-medium line-clamp-1">
            ...
            <div className="relative group">
              <button
                ...
                className={`px-2.5 py-1.5 rounded-lg text-xs 2xl:text-sm font-semibold flex items-center gap-1 transition-all ${
                  isActive('/gallery') || isActive('/upazilas') || isActive('/contact')
          ...
          {/* Action CTAs: Language Switcher & Join Us */}
          ...
          <div className="flex items-center gap-2 xl:hidden">
            ...
            <button
              ...
              className="p-2 rounded-lg text-emerald-100 hover:text-white hover:bg-emerald-800/50 focus:outline-none"
      ...
      {mobileMenuOpen && (
        <div className="xl:hidden bg-slate-900/98 backdrop-blur-xl border-b border-emerald-800/50 px-4 pt-3 pb-6 animate-fadeIn transition-all max-h-[85vh] overflow-y-auto">
          <div className="mb-4 pt-1 pb-2 border-b border-slate-800">
          ...
          <div className="mt-5 pt-4 border-t border-slate-800 flex flex-col gap-3">
            <Link
              to="/join"
              className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-crimson-600 to-rose-700 shadow-lg text-center"
            >
