...
export const SectionHeader = ({ 
  ...
  return (
    <div className={`flex flex-col ${alignmentClass} max-w-3xl ${align === 'center' ? 'mx-auto' : ''} mb-12`}>
      {badge && (
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold tracking-wide uppercase mb-3 bg-emerald-100 dark:bg-emerald-950/70 text-emerald-800 dark:text-emerald-300 border border-emerald-300/60 dark:border-emerald-800/80 shadow-xs">
