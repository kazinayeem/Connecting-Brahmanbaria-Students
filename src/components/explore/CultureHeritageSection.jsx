  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      {cultureData.map((item) => (
        <div
          key={item.id}
          className="rounded-3xl overflow-hidden bg-white border border-slate-200/90 shadow-soft hover:shadow-soft-lg transition-all duration-300 flex flex-col justify-between group"
        >
          {/* Image */}
          ...
          <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
            <div>
              ...
              {/* Features List */}
              <ul className="space-y-1.5 pt-3 border-t border-slate-100 mt-4">
