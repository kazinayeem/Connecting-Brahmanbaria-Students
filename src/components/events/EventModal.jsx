        ...
        <div className="text-center py-8 space-y-4">
          ...
          <div className="pt-4">
            <button
              type="button"
              onClick={handleReset}
              className="px-6 py-2.5 rounded-xl bg-brand-700 text-white text-xs font-bold hover:bg-brand-800 transition-colors shadow-sm"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 rounded-xl text-sm border border-slate-300 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
              />
            </div>
