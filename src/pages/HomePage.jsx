    ...
    <div className="space-y-0">
      ...
      <section className="py-12 bg-gradient-to-r from-brand-950 via-slate-900 to-brand-950 text-white relative overflow-hidden border-y border-emerald-800/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 bg-emerald-950/40 p-8 sm:p-10 rounded-3xl border border-emerald-700/50 backdrop-blur-md">
            ...
            <Link
              to="/explore"
              className="shrink-0 inline-flex items-center gap-2.5 px-8 py-4 rounded-2xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-sm sm:text-base shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-0.5 active:translate-y-0"
            >
      ...
      <section className="py-16 bg-gradient-to-r from-brand-800 via-emerald-900 to-brand-950 text-white relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-crimson-600/90 text-white text-xs font-bold shadow-sm">
